...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach($votes as $index => $vote)
    {
        ...
        if(isset($vote[$userName])){
            ...
            foreach($ideas as $index => $idea){
                if($idea['id'] == $ideaId){
                    if($voteType == "positive") $positiveVotes++ ; 
                    if($voteType == "negative") $negativeVotes++ ; 
...
<body>
    ...
    <div>
        ...
        <p><strong>Votes :</strong> Positifs: <?php echo $idea['votes']['positive']; ?> | Négatifs: <?php echo $idea['votes']['negative']; ?>
        </p>
